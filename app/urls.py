...
urlpatterns = [
    ...
    path("api/home/featured/", views.HomeFeaturedView.as_view(), name="api_home_featured"),
    path("api/home/bestsellers/", views.HomeBestsellersView.as_view(), name="api_home_bestsellers"),
    path("api/home/deal-of-day/", views.HomeDealOfDayView.as_view(), name="api_home_deal_of_day"),
